...
const steps = [
  {
    id: "1",
    message: "Hello! 👋 Welcome to Cash ur Drive. It’s great to see you here.",
    trigger: "2",
  },
  {
    id: "2",
    message:
      "I’m here to guide you through our services. May I know your name, please?",
    trigger: "3",
  },
  {
    id: "3",
    ...
    validator: (value) => {
      if (value.trim().length < 2) {
        return "Hmm, that seems a bit short. Could you please enter your full name?";
      }
      return true;
    },
    trigger: "4",
  },
  {
    id: "4",
    message:
      "Nice to meet you, {previousValue}! 🌟 Could you share your phone number with me? I’ll make sure we keep it confidential.",
    trigger: "5",
  },
  {
    id: "5",
  ...
  },
  {
    id: "6",
    message:
      "Got it, thanks! 📱 Now, could you tell me a bit about what you’re looking for or any specific query you have?",
    trigger: "7",
  },
  {
    id: "7",
  ...
  },
  {
    id: "8",
    message:
      "Thank you for sharing that. Someone from our team will get in touch with you shortly to assist further. 💼 in the mean while you can connect to us via",
    component: (

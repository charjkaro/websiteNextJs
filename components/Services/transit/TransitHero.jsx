...
import {
  staticAdvertisingData,
  transitMediaAdvertisingData,
          ...
          <section className="mb-8 flex flex-col justify-between gap-6 sm:gap-10 md:mb-16 md:gap-16 lg:flex-row">
            <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-8/12">
              <h1 className="mb-8 text-4xl font-bold overflow-hidden text-white sm:text-5xl  md:text-5xl">
                Commute into Success: Ride the Wave of Transit Advertising
                Brilliance!
              </h1>
              <h1 className="mb-8   overflow-hidden text-white  md:mb-12 ">
                Unleash the Power of Moving Minds with Our Unconventional
                Transit Ad Solutions.
              </h1>
            </div>
            ...
            <div>
              <div className="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-full">
                <img
                  ...
                  loading="lazy"
                  src="https://firebasestorage.googleapis.com/v0/b/cashurdrive-28087.appspot.com/o/services%2Fnew%20services%2Ffleet%2Ffleet%20branding%20(2).webp?alt=media&token=f0b2a439-246d-4938-9fa1-e7a979629eef"
                />
              </div>
            </div>
            <div className="md:pt-8">
              <h1 className="mb-4 text-center text-2xl font-bold text-gray-800 sm:text-3xl md:mb-6 md:text-left">
                Unleash Your Brand's Presence
              </h1>
              <p className="mb-6 text-gray-500 sm:text-lg md:mb-8">
                Immerse your brand in the dynamic world of transit advertising,
                where constant motion meets unbeatable visibility. Reach
                millions daily, captivating diverse audiences on buses, trains,
                and transit hubs. Elevate brand recognition, foster engagement,
                and drive results. With transit advertising, your message
                becomes an unmissable part of daily commutes, leaving a lasting
                impression that resonates far beyond the journey's end. Join the
                ranks of successful brands leveraging the inherent power of
                transit advertising to connect, influence, and thrive in the
                ever-moving landscape of consumer attention."
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="py-10">
      ...
      <div className="lg:grid-cols-2 grid gap-4 lg:p-20 p-5">
        {transitMediaAdvertisingData.map((serviceData, index) => {
          return (

          ...
          <section className="mb-8 flex flex-col justify-between gap-6 sm:gap-10 md:mb-16 md:gap-16 lg:flex-row">
            <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-8/12">
              <h1 className="mb-8 text-4xl font-bold overflow-hidden text-white sm:text-5xl  md:text-5xl">
                Elevate Your Brand with Intelligent OOH
              </h1>
              <h1 className="mb-8   overflow-hidden text-white  md:mb-12 ">
                Elevate Your Brand with Intelligent <br /> OOH Elevate Your
                Brand with Intelligent OOH
              </h1>
            </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="md:pt-8">
              ...
              <p className="mb-6 text-gray-500 sm:text-lg md:mb-8">
                We'll help you craft a tailored Media Strategy to target your
                buyer where they work and live. Using our wide range of formats
                and inventory, we'll combine reach and frequency tactics to
                maximize results. We even provide the mobile ID's of your OOH
                viewers so that you can re-target them online.
                <br />
                <br />
